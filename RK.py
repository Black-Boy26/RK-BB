...
logo =                                          """   
   ...
   \033[1;37m
\x1b[1;92m------------------------\x1b[1;92m------------------------
\033[1;31m\033[1;37m Create \x1b[1;97m : \033[1;37m           RIMON KHAN
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          Black-Boy
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           Black-Boy26
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           Black-Boy
\033[1;92m------------------------\033[1;92m------------------------ """                                              
...
def rimon():
    ...
    print(' [2] Make File')
    print(' [3] Start Cloning')
    print(' [4] YouTube Channel')
    print(' [5] Facebook Id')
    print(' [E] exit ')
    print('')
    _rimon___ = input(' [?] Choose option : ')
    if _rimon___ in ('1', '01'):
        __xxx__().rimonx(id)
    if _rimon___ in ('2', '02'):
        os.system('python2 Black-RK.py')
    if _rimon___ in ('3', '03'):
    	os.system('python2 rimon.py')
    if _rimon___ in ('4', '04'):
    	os.system('https://youtube.com/channel/UCqxOoOna3t7q3xdixiJ456w')
    if _rimon___ in ('5', '05'):
    	os.system('https://www.facebook.com/BlackHacker2468')
    if _rimon___ in ('E', 'ee'):
    	pass
